...
find_library(OpenCv_LIBRARY_RELEASE NAMES opencv_core${OpenCv_COMPACT_VERSION_STRING} opencv_core HINTS ${OpenCv_LIBRARY_DIR})
find_library(OpenCv_LIBRARY_DEBUG NAMES opencv_core${OpenCv_COMPACT_VERSION_STRING}d opencv_cored HINTS ${OpenCv_LIBRARY_DIR})
...
if(NOT Ml_FOUND_INDEX EQUAL -1)
    ...
    find_library(OpenCv_Ml_LIBRARY_RELEASE NAMES opencv_ml${OpenCv_COMPACT_VERSION_STRING} opencv_ml HINTS ${OpenCv_LIBRARY_DIR})
    find_library(OpenCv_Ml_LIBRARY_DEBUG NAMES opencv_ml${OpenCv_COMPACT_VERSION_STRING}d opencv_mld HINTS ${OpenCv_LIBRARY_DIR})
...
if(NOT ImgProc_FOUND_INDEX EQUAL -1)
    ...
    find_library(OpenCv_ImgProc_LIBRARY_RELEASE NAMES opencv_imgproc${OpenCv_COMPACT_VERSION_STRING} opencv_imgproc HINTS ${OpenCv_LIBRARY_DIR})
    find_library(OpenCv_ImgProc_LIBRARY_DEBUG NAMES opencv_imgproc${OpenCv_COMPACT_VERSION_STRING}d opencv_imgprocd HINTS ${OpenCv_LIBRARY_DIR})
...
if(NOT flann_FOUND_INDEX EQUAL -1)
    ...
    find_library(OpenCv_Flann_LIBRARY_RELEASE NAMES opencv_flann${OpenCv_COMPACT_VERSION_STRING} opencv_flann HINTS ${OpenCv_LIBRARY_DIR})
    find_library(OpenCv_Flann_LIBRARY_DEBUG NAMES opencv_flann${OpenCv_COMPACT_VERSION_STRING}d opencv_flannd HINTS ${OpenCv_LIBRARY_DIR})
